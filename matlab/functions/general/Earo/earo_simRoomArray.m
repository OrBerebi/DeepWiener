...
function [eobj, anm, fVec] = earo_simRoomArray(N, roomDims, recPos, srcAngPos, srcType, freqAbs, alphaAbs, fs, array_radius, sphereType)
    ...
    Receivers=AddReceiver('Location',recPos,'Type','sphharm','MaxOrder',N,'NFComp',false);
